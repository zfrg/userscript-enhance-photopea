...
(function() {
    ...
    .topbar::before {
        ...
        height: 18px;
        margin-right: 10px;
        background-image: url(https://www.photopea.com/promo/thumb256.png);
    ...
    `)
    GM_addStyle(`
    div.flexrow.app:last-child > div:first-child > div:nth-child(3) > div:first-child {
        right: calc(100vw - env(titlebar-area-width, 100vw) - env(titlebar-area-x, 0px)) !important;
    }
    `)
